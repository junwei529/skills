...
| Windows-to-WSL execution | Load WSL guidance; verify distribution, user, working directory, Linux paths, streams, and exit status separately | Ask before WSL state changes or Linux elevation |
