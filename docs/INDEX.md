...
| [`docs/decisions/0018-work-charter-adoption-levels-and-reentry-checkpoint.md`](decisions/0018-work-charter-adoption-levels-and-reentry-checkpoint.md) | Work Charter two-stage natural-language entry, proportional protection levels, durable re-entry, task convergence, evaluation, workspace, and lifecycle gates | accepted design; `92a8c045...` Gate 2 stopped at A04 on selected/loaded identity; the dirty lazy-entry revision is offline-verified, while native review, commit, and all later candidate gates remain pending |
