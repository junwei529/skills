...
| [`docs/decisions/0018-work-charter-adoption-levels-and-reentry-checkpoint.md`](decisions/0018-work-charter-adoption-levels-and-reentry-checkpoint.md) | Work Charter native-package/explicit-activation entry, proportional protection levels, durable re-entry, task convergence, evaluation, workspace, and lifecycle gates | accepted through terminal `WC-AR-D53-LAYERED-AUTHORIZATION-LIFECYCLE`; reviewed tracked lifecycle commit `4ab8a025...` passes 32/32, but Layer A exhausted three corrections and failed stage 7 before Layer B, aggregate 56/56, or model evidence; D51-D53 remain immutable, D53 is `QUALIFICATION_FAILED / PRODUCT_UNKNOWN`, and candidate `c481005...` remains unaccepted |
