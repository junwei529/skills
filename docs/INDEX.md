...
| [`docs/decisions/0018-work-charter-adoption-levels-and-reentry-checkpoint.md`](decisions/0018-work-charter-adoption-levels-and-reentry-checkpoint.md) | Work Charter two-stage natural-language entry, proportional protection levels, durable re-entry, task convergence, evaluation, workspace, and lifecycle gates | accepted design; exact D31 candidate `07a9f1c...` remains unaccepted after D33/D35 infrastructure `UNKNOWN` records and D36's incomplete A13 product hard stop with assessor `DECISION_REQUIRED`; see the Work Charter State and Verification ledgers |
