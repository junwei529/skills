...
| [`docs/decisions/0018-work-charter-adoption-levels-and-reentry-checkpoint.md`](decisions/0018-work-charter-adoption-levels-and-reentry-checkpoint.md) | Work Charter native-package/explicit-activation entry, proportional protection levels, durable re-entry, task convergence, evaluation, workspace, and lifecycle gates | accepted through active `WC-AR-D53-LAYERED-AUTHORIZATION-LIFECYCLE`, its live-controller Replan Delta, and the 2026-08-13 review-finding reset; D51 and terminal D52 remain immutable; new-cycle reviews 1-2/5 terminal-closeout and early-terminal findings are corrected and focused 32/32 passes, while a clean final-byte review remains required before commit 1 and candidate `c481005...` remains unaccepted |
