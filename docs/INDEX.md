...
| [`docs/decisions/0018-work-charter-adoption-levels-and-reentry-checkpoint.md`](decisions/0018-work-charter-adoption-levels-and-reentry-checkpoint.md) | Work Charter native-package/explicit-activation entry, proportional protection levels, durable re-entry, task convergence, evaluation, workspace, and lifecycle gates | accepted through D44; D44 completed final qualification, three network-capable canaries, freeze, and one A01 product turn, but sealed at 0/27 on a frozen semantic-gate false negative; a later assessor turn violated the admitted-cell prerequisite and is excluded from D44 assessment evidence, so the candidate remains unaccepted; see the Work Charter State and Verification ledgers |
