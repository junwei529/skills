...
| [`docs/decisions/0018-work-charter-adoption-levels-and-reentry-checkpoint.md`](decisions/0018-work-charter-adoption-levels-and-reentry-checkpoint.md) | Work Charter two-stage natural-language entry, proportional protection levels, durable re-entry, task convergence, evaluation, workspace, and lifecycle gates | accepted design through D33; exact D31 candidate `07a9f1c...` remains unaccepted after immutable D33 transport and D35 controller-orchestration `UNKNOWN` records; see the Work Charter State and Verification ledgers |
