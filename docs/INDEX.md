...
| [`docs/decisions/0018-work-charter-adoption-levels-and-reentry-checkpoint.md`](decisions/0018-work-charter-adoption-levels-and-reentry-checkpoint.md) | Work Charter native-package/explicit-activation entry, proportional protection levels, durable re-entry, task convergence, evaluation, workspace, and lifecycle gates | accepted design through D42; exact candidate `f24bda7...` and its immutable 4/27 D42 packet remain unaccepted after static qualification was invalidated and A05 applied workflow before activation, with qualification coverage and entry policy `DECISION_REQUIRED`; see the Work Charter State and Verification ledgers |
