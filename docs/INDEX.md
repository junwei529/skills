...
| [`docs/decisions/0018-work-charter-adoption-levels-and-reentry-checkpoint.md`](decisions/0018-work-charter-adoption-levels-and-reentry-checkpoint.md) | Work Charter native-package/explicit-activation entry, proportional protection levels, durable re-entry, task convergence, evaluation, workspace, and lifecycle gates | accepted through D45; D44 remains an immutable 0/27 semantic-gate false-negative terminal with one excluded assessor deviation, while D45 authorizes only the two ignored evaluation-gate corrections and a fresh unchanged additive packet; see the Work Charter State and Verification ledgers |
